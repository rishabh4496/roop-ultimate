...
export function AppShell({ route, onNavigate, children }) {
  ...
  return <div className="v2-app-shell">
    ...
    <aside className={`v2-sidebar ${navOpen ? 'is-open' : ''}`} aria-label="V2 navigation">
      <div className="v2-brand"><span className="v2-brand-mark">R</span><span><strong>Roop Ultimate</strong><small>React UI 2.0 foundation</small></span></div>
      ...
      <div className="v2-sidebar-foot"><Badge tone="neutral">Foundation only</Badge><small>Processing and backend integration are intentionally not connected.</small></div>
    </aside>
