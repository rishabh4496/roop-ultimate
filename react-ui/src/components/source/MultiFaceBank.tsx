...
import {
  ...
  POSE_DEFINITIONS,
  CANONICAL_ANGLES,
  evaluateCentroidRobustness,
  analyzeCaptureLuminance,
} from './robustness';

export type { PoseAngle, FaceCapture, CentroidResponse };
...
export const MultiFaceBank = forwardRef<MultiFaceBankRef, MultiFaceBankProps>(
  (
    ...
    const radarData = useMemo(() => {
      ...
      // 5 axes: Top = Up, Top-Right = Right 45, Bottom-Right = Down, Bottom-Left = Left 45, Top-Left = Frontal
      // Or natural spatial placement:
      // Index 0: Frontal (Top, -90°)
      // Index 1: Right 45 (-90° + 72° = -18°)
      // Index 2: Down (-18° + 72° = 54°)
      // Index 3: Left 45 (54° + 72° = 126°)
      // Index 4: Up (126° + 72° = 198°)
      ...
      // Points on the outer ring for concentric polygon guidelines
