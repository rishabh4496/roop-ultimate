    ...
    <div className="flex flex-col lg:flex-row gap-4 items-start w-full">
      ...
      <div className={`w-full lg:w-[350px] 3xl:w-[400px] 4xl:w-[460px] shrink-0 space-y-3.5 select-none ${!showLeftPanel ? 'hidden' : ''}`}>
        ...
        <Section title="Mouth & Angle math" collapsible defaultOpen={false}>
          ...
          <Toggle label="↔️ Frontalize angled faces" info="Un-rotates steep profile/side (lateral) faces before swapping, then restores the original angle. WARNING, measured 2026-09-25 (hyperswap, angle clips, 218 frames): wherever it fires the swap is effectively LOST — identity to the source 0.52 → 0.03 at 45-75° yaw while the output stays 0.57 similar to the original person — and the face shows tearing and doubled features. Leaving it off measured better at every yaw band. Keep off unless you have checked the result on your footage." checked={!!p.use_frontalization} onChange={(v) => set('use_frontalization', v)} />
