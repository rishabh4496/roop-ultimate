...
export const BUILTIN_PROFILES = [
  ...
  {
    id: 'cinematic',
    name: '🎨 Cinematic Master (UltraMax Photoreal)',
    ...
    msPerFrame: 25,
    timePer1000f: 25,
    description: 'UltraMax enhancer (GPEN-512 + CodeFormer texture residual) with RealSwap and RealityUX fusion mask for maximum photographic realism.',
    settingsSummary: [
      { label: 'Face Swapper', value: 'RealSwap', active: true },
      { label: 'Enhancer Pass', value: 'UltraMax (GPEN+CodeFormer)', active: true },
      { label: 'Mask Parse Engine', value: 'RealityUX Fusion', active: true },
      { label: 'Skin Detail Transfer', value: '0.40 (Natural Pores)', active: true },
