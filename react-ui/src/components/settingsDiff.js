...
export const LABELS = {
  ...
  adaptive_enhancer_profile: 'Adaptive profile',
  ...
  restoration_mode: 'Restoration mode',
  tile_diffusion_strength: 'Tile diffusion strength',
  tile_diffusion_steps: 'Tile diffusion steps',
