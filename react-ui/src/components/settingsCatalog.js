...
export const SETTINGS_CATALOG = [
  ...
  { key: 'hdr_pipeline', label: 'HDR / high-bit-depth colour path', section: 'Output' },
  { key: 'hdr_source_transfer', label: 'Source transfer curve (HDR)', section: 'Output' },
  { key: 'hdr_source_primaries', label: 'Source colour primaries (HDR)', section: 'Output' },
  { key: 'hdr_output_codec', label: 'HDR output codec', section: 'Output' },
